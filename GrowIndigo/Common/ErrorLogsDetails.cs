...
namespace GrowIndigo.Common
{
    public class CommonClasses
    {
        ...
        public bool SendOTP(string otp, string mobileNumber)
        {
            try
            {
                string message = " Your OTP Code is : " + otp + " hAvexoxSJ01&sender=MAHYCO&mobile=" + mobileNumber + "&otp=" + otp;
                string strUrl = "http://control.msg91.com/api/sendotp.php?authkey=236638A2qjFh8bbBMv5b9607d8&message=%3C%23%3E" + message;
