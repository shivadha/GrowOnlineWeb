        ...
        public HttpResponseMessage AddProduct(ProductMasterViewModel objProductMasterViewModel)
        {
            try
            {
                ...
                if (number != null)
                {
                    ...
                    objMandi_ProductMaster.ServiceTax = (decimal)0.05;
       ...
       [Authorize]
        ...
        public HttpResponseMessage GetProduct(ProductFilter objProductFilter)
        {
            try
            {
                ...
                var getOrderHistoryDetail = (from product in dbContext.Mandi_OrderDetails where product.Buyer_Mobile == objProductFilter.MobileNumber && product.TransactionStatus == "Submitted" select product).ToList();
                ...
                else if (objProductFilter.IsAllActiveProducts == "true" /*&& getUser.UserType == "Buyer"*/)
                {
                    ...
                    if (getOrderHistoryDetail == null || getOrderHistoryDetail.Count == 0)
                    {
                        ...
                        //        if (distance < 2000)          //nearbyplaces which are within 4 miles 
                        //        {
